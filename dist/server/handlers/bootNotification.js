...
async function handleBootNotification(req, chargePointId, ws) {
    try {
      ...
      saved to MongoDB`);
        ...
        setTimeout(() => {
            logger_1.logger.info(`[BootNotification] Triggering StatusNotification for ${chargePointId}`);
            (0, remoteControl_1.sendRemoteMessage)(index_1.connectionManager, chargePointId, 'TriggerMessage', {
